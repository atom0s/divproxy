...
----------------------------------------------------------------------------------------------------
--
-- Functional Helpers (Coroutine Forwards via Hook Tasks)
--
----------------------------------------------------------------------------------------------------
...
function_mt.repeating = function (self, delay, repeats, repeat_delay, ...)
    hook.tasks.repeating(delay, repeats, repeat_delay, self, ...);
end
...
function_mt.repeatingf = function (self, delay, repeats, repeat_delay, ...)
    hook.tasks.repeatingf(delay, repeats, repeat_delay, self, ...);
end
